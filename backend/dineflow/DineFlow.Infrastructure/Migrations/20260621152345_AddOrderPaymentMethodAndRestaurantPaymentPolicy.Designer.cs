...
namespace DineFlow.Infrastructure.Migrations
{
    ...
    [Migration("20260621152345_AddOrderPaymentMethodAndRestaurantPaymentPolicy")]
    partial class AddOrderPaymentMethodAndRestaurantPaymentPolicy
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("Carts", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Carts_TableOrderType", "(\"OrderType\" = 0 AND \"TableId\" IS NOT NULL) OR (\"OrderType\" <> 0 AND \"TableId\" IS NULL)");
                        });
                });
